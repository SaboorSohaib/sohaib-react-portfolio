...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      review:
        "Abdul is a developer you'll surely want on your team due to his perseverance, he stiffs to know more and is open to learning something new. He offers help whenever he can and is also a good team player. He loves professionalism and strives to get the job done, efficiently though. I recommend Abdul for any job involving a team player and efficient code writing.",
    },
    {
      id: 3,
  ...
  return (
    <section id='testimonials'>
      ...
      >
        {testimonials.map(({ id, link, name, review }) => (
